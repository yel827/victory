<template>
  <div class="box">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="能力管理" name="first" :span="12">
        <div class="tabone">
          <el-form ref="form" :model="form" label-width="70px" style="display:flex;">
          ...
          <el-table :data="tableData" stripe style="width:100%">
            <el-table-column prop="date" label="ID" width="200"></el-table-column>
            <el-table-column prop="date" label="能力名称" width="200"></el-table-column>
            <el-table-column prop="date" label="能力编号" width="200"></el-table-column>
            <el-table-column prop="name" label="创建时间" width="300"></el-table-column>
            <el-table-column prop="address" label="更新时间" width="300"></el-table-column>
            <el-table-column label="操作" width="300">
              ...
              <template slot-scope="scope">
                ...
                <el-button type="text">
                  <i class="icon iconfont icon-shanchu" style="font-size:18px; font-weight:bold;color:yellow"></i>
                </el-button>
                <!-- <el-dialog 
                width='54%' 
                title="能力监控详情" 
      ...
      <el-tab-pane label="能力地址管理" name="second" :span="12">
        <div class="tabtwo">
          <el-form ref="form" :model="form" label-width="70px" style="display:flex;">
            <el-form-item label="活动名称">
              <el-input v-model="form.name" label-width="80px"></el-input>
          ...
          <el-table :data="tableData" stripe style="width:100%">
            <el-table-column prop="date" label="ID" width="200"></el-table-column>
            <el-table-column prop="date" label="能力名称" width="200"></el-table-column>
            <el-table-column prop="date" label="能力URL地址" width="200"></el-table-column>
            <el-table-column prop="name" label="创建时间" width="300"></el-table-column>
            <el-table-column prop="address" label="更新时间" width="300"></el-table-column>
            <el-table-column label="操作" width="300">
              <!-- 能力监控操作详情 -->
              <template slot-scope="scope">
                ...
                <el-button type="text">
                  <i class="icon iconfont icon-shanchu" style="font-size:24px; font-weight:bold;"></i>
                </el-button>
                <!-- <el-dialog 
                width='54%' 
                title="能力监控详情" 
