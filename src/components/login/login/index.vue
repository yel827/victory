...
.bg .bg1 .left div:nth-child(2) {
  flex: 1;
  line-height: 60px;
  background: url(../../assets/canvas1.png) no-repeat center center;
  background-size: 100%;
}
.bg .bg1 .left div:nth-child(1) {
  width: 100%;
  height: 60px;
  line-height: 60px;
}

.bg .bg1 .left div:nth-child(1) .tu_wen {
  height: 60px;
  width: 220px;
  float: left;
}
.bg .bg1 .left div:nth-child(1) span {
...
.bg .bg1 .right .right_project .btn {
  width: 80%;
  height: 60px;
  margin-right: 10%;
  margin-top: 16%;
...
.bg .bg1 .right .right_project .input_A {
  width: 100%;
  height: 50px;
  margin-top: 40px;
}
.bg .bg1 .right .right_project .input_A img {
  float: left;
  width: 40px;
  height: 50px;
}
.bg .bg1 .right .right_project .input_A .tet {
  float: left;
  width: 90%;
  height: 100%;
  border-top: none;
